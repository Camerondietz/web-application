...
export default function ProductDetailPage() {
  ...
  if (error) return <p className="text-center text-red-500 py-10">{error}</p>;
    ...
    // SEO-related structured data for the product page
  const structuredData = {
    ...
    brand: {
      "@type": "Brand",
      name: product.category || "Unknown Brand",
    },
    offers: {
      "@type": "Offer",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={product.description || "Product description goes here."} />
        <meta name="robots" content="index, follow" />
        
        {/* Open Graph for social sharing */}
        <meta property="og:title" content={product.name} />
        <meta property="og:description" content={product.description} />
        <meta property="og:image" content={product.image ? `${process.env.NEXT_PUBLIC_API_URL}${product.image}` : '@/public/large_on_black.jpg'} />
