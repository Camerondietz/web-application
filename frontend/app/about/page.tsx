    ...
    <div className="container mx-auto px-4 py-10">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            <img src="/profile.png" className="w-24 h-24 mx-auto mb-2 bg-gray-300 dark:bg-gray-700 rounded-full"></img>
          ...
          <div className="text-center">
            <img src="/pi.jpg" className="w-24 h-24 mx-auto mb-2 bg-gray-300 dark:bg-gray-700 rounded-full"></img>
      ...
      <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <li><strong>DevOps:</strong> Docker, Raspberry Pi hosting, Cloudflare Tunnel</li>
              </ul>
            </div>
      <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <li>Lightweight, Dockerized deployment on Raspberry Pi</li>
